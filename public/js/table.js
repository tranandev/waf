...
$(".add-row").click(function(){
  $("#editableTable").find("tbody tr:first").before("<tr><td data-field='name'></td><td data-field='name'></td><td data-field='name'></td><td data-field='name'></td><td><a class='button button-small edit' title='Edit'><i class='fa fa-paint-brush'></i></a> <a class='button button-small' title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>");   
  editTable();  
  setTimeout(function(){   
