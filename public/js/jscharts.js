    ...
    this.gg = function() {
        ...
        for (var iU = 0; iU < kj; iU++) {
            ...
            for (eQ = 0; eQ < eP; eQ++) {
                ...
                fV = '<div ' + 'style="display:none;position:absolute;' + 'left:' + (this.ba.offsetLeft + fh) + 'px;' + 'top:' + (this.ba.offsetTop + fn) + 'px;' + 'width: 10px;' + 'height: 10px;' + 'font-size: 1px;' + 'z-index: ' + (Number(this.ba.style.zIndex) + 200) + ';' + '" id="trigger_legend_' + parseInt(fh, 10) + '_' + parseInt(fn, 10) + '">' + '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" ' + 'width="' + (this.br * 2) + '" ' + 'height="' + (this.br * 2) + '" ' + "><\/div>";
